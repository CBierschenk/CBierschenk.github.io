  ...
  about: {
    main: {
      text: [
        ...
        "<p><h4>- Software development in automotive</h4></p>",
        "<p><h4>- DevOps</h4></p>",
        "<p><h4>- Circuit design in aviation</h4></p>",
      ],
      img: "./imgs/about.JPG",
